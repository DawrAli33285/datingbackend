...
const createSubscription = async (req, res) => {
    ...
    try {
        ...
        await usermodel.findByIdAndUpdate(req.user.id, { isPremium: true, subscription: subscription._id })
...
const cancelSubscription = async (req, res) => {
    ...
    try {
        ...
        console.log("SUB CANCEL ERROR")
        console.log(error.message)
        res.status(500).json({ message: 'Server error', error: error.message })
    }
}

module.exports = { createSubscription, getUserSubscription,cancelSubscription }